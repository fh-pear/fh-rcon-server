...
public class Client
{
   ...
   //private Database db;
	 ...
	 *            Example line:   9    70  309 aaaa1234567890bbbbbbcccccccddddd 77solor^7               0 75.35.141.4:9704
	 */
  ...
  /* public void getClientDetails()
   ...
   public String toString(boolean fullDetails)
   {
	...
	/**
	 * checkGuid() will check guid for any irregularities. prevents malfromed guids.
	 * If a malformed guid is found, calls the kickClient() method to invoke a rcon kick command.
	 * Guid spoofing is a common problem. This method will help combat some of it by detecting and 
	 * kicking malformed guids 
	 */
